...
#define UE_PROJECT_NAME FilePicker
#define UE_TARGET_NAME FilePickerEditor
...
#define FILEPICKERPLUGINED_API DLLEXPORT
#define FILEPICKERPLUGIN_API DLLIMPORT
